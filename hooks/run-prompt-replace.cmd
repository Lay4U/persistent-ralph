...
REM Persistent Ralph - Prompt-Replace Hook Windows Wrapper
REM Executes prompt-replace.sh using Git Bash
...
"%BASH_PATH%" -c "cd \"%CD%\" && export SCRIPT_DIR='%UNIX_SCRIPT_DIR%' && . '%UNIX_SCRIPT_DIR%prompt-replace.sh'"
